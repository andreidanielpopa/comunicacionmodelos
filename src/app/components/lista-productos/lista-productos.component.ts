...
export class ListaProductosComponent {
  ...
  constructor() {
    this.producto = new Producto('Camiseta', 'https://m.media-amazon.com/images/I/B1pppR4gVKL._CLa%7C2140%2C2000%7CA1ACbkHScQL.png%7C0%2C0%2C2140%2C2000%2B0.0%2C0.0%2C2140.0%2C2000.0_AC_UY580_.png', 30);
    this.productos = [
      new Producto(
        "Nike Air Jordan",
